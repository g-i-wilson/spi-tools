...
defaultMap =    [ \
                ...
                [0x01, 0x18, 0x80, "IO_CONFIG IO Configuration 8.5.2"], \
                ...
                [0x1F, 0x00, 0x00, "FREQ_NCOAB Frequency"], \
                [0x20, 0x00, 0x00, "FREQ_NCOAB Frequency"], \
                [0x21, 0x00, 0x00, "0x21-0x23 0x0000 FREQ_NCOCD Frequency for CD path NCO 8.5.26"], \
                [0x22, 0x00, 0x00, "FREQ_NCOCD Frequency"], \
                [0x23, 0x00, 0x00, "FREQ_NCOCD Frequency"], \
...
def printReg(addrByte, twoByteArray, note=""):
